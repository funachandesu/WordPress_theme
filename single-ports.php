...
<?php
    ...
    <section class="blog_wrap" style="flex-flow: column;">
      <section class="blog_page">
        ...
        <p class="blog_cate"><a href="<?php echo esc_url(home_url('/')); ?><?php echo $cat_slug; ?>/<?php foreach($category as $cat){if($cat->parent){echo $cat->slug;}};?>">
